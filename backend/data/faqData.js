const faqs = [
    {
        question: "Hii",
        keywords: ["Hello", "Hey", "Hello there", "Hii"],
    ...
    },
    {
        ...
        answer: "We accept COD, Stripe, and Razorpay.",
    },
    {
        question: "Do you have size charts?",
        keywords: ["size", "chart", "fit"],
        answer: "Yes, each product page has a size chart for reference.",
    },
    {
        question: "How can I track my order?",
        keywords: ["track", "order", "status"],
        answer: "After your order is shipped, you will receive a tracking ID via email.",
    },
    {
        question: "Do you deliver internationally?",
        keywords: ["international", "shipping", "deliver"],
    ...
    // },
    {
        ...
        answer: "You can reach us via email or our support chat.",
    },
    {
        question: "What if the product is damaged?",
        keywords: ["damaged", "broken", "replace"],
        answer: "You can request a replacement within 7 days of delivery.",
    },
    {
        question: "Do you restock sold-out items?",
        keywords: ["restock", "sold out", "available"],
        answer: "Yes, we restock popular items regularly.",
    },
    {
        question: "Do you offer bulk discounts?",
        keywords: ["bulk", "discount", "wholesale"],
        answer: "Yes, contact us for bulk order inquiries.",
    },
    {
